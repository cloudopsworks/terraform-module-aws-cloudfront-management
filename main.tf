...
resource "aws_cloudfront_distribution" "this" {
  ...
  default_cache_behavior {
    ...
    target_origin_id       = try(var.settings.default_cache_behavior.target_origin_id, format("%s-%s", var.settings.origins[var.settings.default_origin], local.cloudfront_name_short))
